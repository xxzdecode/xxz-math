...
- 知识点库：按沪教版口径从一年级到七年级顺序列出非图形知识点，支持搜索、年级/领域筛选和详情阅读；老师登录后切换姐姐 / Crystal 与弟弟 / Gavin，并用红、黄、绿三色直接标记掌握状态。
...
当前公开快照为 schema v3，只保留一至七年级、领域、知识点标题、简明内容与顺序，不包含学生身份、本地教材路径、交接基线、教学状态、掌握状态或证据。图形知识暂不放入知识点库；学生私有状态只在老师登录后由教师 API 读取。
